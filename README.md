...
| `skills/ceratops-credit-savings-analysis/scripts/credit_analysis/report_bookkeeping.py` | Owns pure result-shape validation, surface ordering, and temporary-control report links; derives missing links only from validated review decisions with unambiguous ownership, preserving judgments and rejecting conflicting links. |
