...
- When two active sources use different identities for the same required item, treat the producer/current source as authoritative, update stale consumers or gates to match it, and ask if authority is unclear.
