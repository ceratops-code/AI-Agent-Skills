...
- Keep shared Ceratops core rules in `templates/common-core.md`, keep GH-only wording inline there only when the rule truly applies only to GitHub or registry tasks, and keep routine GH best-practice audit work in `skills/ceratops-gh-standards-update/` instead of normal GH task skills.
