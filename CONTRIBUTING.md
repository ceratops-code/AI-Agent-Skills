...
- Keep shared Ceratops core rules in `templates/common-core.md`, keep GH-only overlay rules in `templates/common-core-gh.md`, and keep routine GH best-practice refresh work in `skills/ceratops-gh-best-practice-update/` instead of normal GH task skills.
