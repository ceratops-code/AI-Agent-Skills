...
- Keep shared Ceratops rules in `templates/sections/` plus `templates/skill-sections.json`, keep the universal section minimal, keep GH-only wording in GH-only sections, and keep routine GH best-practice audit work in `skills/ceratops-gh-skills-standards-update/` instead of normal GH task skills.
